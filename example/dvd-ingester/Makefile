...
package: changelog clean
	...
	cp -R AGENTS.md CHANGELOG.md CODEX_TASK.md MUSTER.md README.md RELEASE.md SECURITY.md VERSION muster.yaml bin etc src systemd udev tests "$(PACKAGE_ROOT)/"
